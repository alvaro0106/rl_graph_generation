...
def get_normalized_values():
    fname = '/home/alvaro/Desktop/proyectos/rl_graph_generation/gym-molecule/gym_molecule/dataset/250k_rndm_zinc_drugs_clean.smi'
...
# smile = 'C'*38
# smile = 'CCCCCCCCCC(CCC)(CCCCCCC)CCCCCCCCC(CCCCC)CC(C)C' alv
# print(smile, reward_penalized_log_p(Chem.MolFromSmiles(smile))) alv
